      ...
      <div className="w-full p-5 h-full ">
        <div className="rounded-md h-full flex flex-col gap-5">
          ...
          <div className="rounded-md  p-2 bg-[#aedcff]">
            ...
            <h1 className="font-medium">Card Withdrawal coming soon....</h1>
          </div>
          <div className=" bg-neutral-200 rounded-md min-h-[400px] p-3 ">
            ...
            <div className="w-full flex justify-center items-center flex-col h-[300px]">

...
const Page = () => {
  ...
  return (
    <div className="p-5 w-full">
      ...
      <p>Transfer your funds to your bank account or to your digital wallet</p>
      <div className="border flex flex-col gap-5 p-3 min-h-[300px] rounded-md">
        ...
        <div className="flex flex-col gap-3">
          <div
            ...
            className="bg-green-200 flex justify-center items-center rounded-md h-[100px]"
          >
            Cash App{" "}
          </div>
          <div
            className="bg-green-200 rounded-md h-[100px] flex justify-center items-center "
            onClick={() => {
